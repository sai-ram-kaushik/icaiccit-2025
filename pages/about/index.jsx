            ...
            <div>
              <div className="text-gray-600 my-3 mt-8">
                <p className="text-justify leading-8 font-sans text-lg text-gray-600">
                  Manav Rachna International Institute of Research and Studies
                  (MRIIRS), formerly MRIU, a Deemed-to-be-University under
                  section 3 of the UGC Act, 1956, and a NAAC accredited ‘A’
                  Grade Institution, is a continuum of excellence from the
                  Career Institute of Technology and Management (CITM). MRIIRS
                  has been awarded a 5-Star QS rating for Teaching, Facilities &
                  Social Responsibility. MRIIRS is ranked among top institutions
                  by the Ministry of Education’s NIRF Ranking 2021. It strives
                  for high-quality education in the fields of Engineering &
            ...
            <div>
              <div className="text-gray-600 my-3 mt-8">
                <p className="text-justify leading-8 font-sans text-lg text-gray-600">
                  ...
                  concepts both theoretically and practically. Keeping in view
                  the growth in industry and increasing demand for computer
                  ...
                  Engineering. Computer Science and Engineering (CSE) is a
                  highly sought-after course because it acts as a catalyst and
                  allows one to keep up with the digital era. The platforms are
                  incredibly diversified, with a huge range of job
                  opportunities. This course is offered to students at the
                  undergraduate as well as the postgraduate levels and students
                  obtain the B.Tech and M.Tech degrees, respectively.The B.Tech
                  (CSE) programme offered by the Department has been accredited
                  thrice by the National Board of Accreditation (NBA) in 2003,
                  2007, and 2018.
                </p>
              </div>
            </div>
